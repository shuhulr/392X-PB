...
void lowGoalSkills() {
    ...
    drop.extend();
    pros::delay(100);  /// MAKE THIS 100 BEFORE RUN !!!!!!!!!!!!!!!!!!!!
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_BRAKE);
    ...
    // pros::delay(300);
    pros::delay(25);
    chassis.turnToPoint(-24.4, 23.8, 550, {}, false);
    matchloader.retract();
    shotgun.move(-55);
    ...
    // score on mid goal
    chassis.moveDistance(5, 350, {}, false);
    matchloader.retract();

    chassis.turnToPoint(5.5, -5, 600, {}, false);
    chassis.moveDistance(17.6, 580, {.maxSpeed = 70}, false);
    ...
    intake.move(-128);
    chassis.moveToPoint(-46, 48, 1100, {.forwards=false, .maxSpeed=95, .maxAngularSpeed=10}, false);
    matchloader.extend();
    shotgun.move(-35);
    Intake();
    pros::delay(300);
    ...
    chassis.turnToPoint(-47, 72, 700, {}, false);
    chassis.moveDistance(20, 600, {.maxSpeed = 45}, false);
    moveWithVoltage(30, 30);
    pros::delay(1500);
    moveWithVoltage(-30, -30);
    ...
    chassis.moveDistance(18, 600, {}, false);
    
    

    chassis.turnToPoint(-65, -42, 500, {}, false);
    ...
    chassis.moveToPoint(-48, -42, 500, {.forwards = false, .maxAngularSpeed=10}, false);
    ...
    //matchload 2
    matchloader.extend();
    chassis.moveToPoint(-47, -48, 500, {.maxSpeed = 85, .maxAngularSpeed=10}, false);
    chassis.turnToPoint(-47.2, -72, 300, {}, false);
    Intake();
    ...
    drop.extend();
    pros::delay(100);  // CHANGE BACK TO 100 !!!!!!!!!!!!!!!!!!!!!
    ...
    chassis.moveToPoint(-17, -64.7, 800, {.maxSpeed=100}, false);
...
void soloSigAWP() {
    ...
    pros::delay(200);
    chassis.turnToPoint(-47.8, -24, 600, {.forwards = false}, false);
    Intake();
    ...
    resetArm();
    intake.move(-128);
    chassis.moveToPoint(-48, -67, 800, {.maxSpeed = 80, .maxAngularSpeed = 10});
    pros::delay(200);
    Intake();
    shotgun.move(0);
    chassis.waitUntilDone();
    moveWithVoltage(35, 35);
    pros::delay(700);
    chassis.moveToPoint(-48, -48, 400, {.forwards = false}, false);
...
void lowGoalSoloSigAWP() {
    ...
    chassis.moveToPoint(47, -50, 800, {.maxSpeed = 90}, false);
    ...
    pros::delay(700);
    chassis.moveToPoint(48, -48, 400, {.forwards = false}, false);
    chassis.turnToPoint(5, -5, 670, {}, false);
    matchloader.retract();
    chassis.moveToPoint(11, -11, 1200, {.maxSpeed = 90, .maxAngularSpeed = 20}, false);
    intake.move(-41);
}
