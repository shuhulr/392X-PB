...
void lowGoalSkills() {
    ...
    chassis.moveToPoint(-27, 27, 500, {.forwards=false, .maxAngularSpeed=15}, false);
    drop.extend();
    pros::delay(200);
    ...
    pros::delay(500);
    stopIntaking();
    chassis.moveDistance(-15, 900, {.forwards=false, .maxSpeed=25});
    pros::delay(100);
    passTheJuice.retract();
    Intake();
    Score(90);
    ...
    chassis.waitUntilDone();
    intake.move(-128);
    chassis.moveToPoint(-46.2, 48, 1100, {.forwards=false, .maxSpeed=95, .maxAngularSpeed=10}, false);
    matchloader.extend();
    shotgun.move(-35);
    Intake();
    pros::delay(300);
    ...
    chassis.turnToPoint(-48.2, -24, 500, {.forwards=false}, false);
    // descorer.toggle();
    Intake();
    ...
    //matchload 2
    matchloader.extend();
    chassis.moveToPoint(-47.8, -48, 500, {.maxSpeed = 85, .maxAngularSpeed=10}, false);
    passTheJuice.extend();
    chassis.turnToPoint(-47.8, -72, 500, {}, false);
    Intake();
...
void soloSigAWP() {
    ...
    //matchload
    chassis.moveToPoint(46, -48, 900, { .maxSpeed = 85, .maxAngularSpeed = 10}, false);
    ...
    stopIntaking();
    chassis.moveDistance(-20, 500, {.forwards = false}, false);
    moveWithVoltage(-40, -40);
    pros::delay(100);
    Score(47);
    // reset 
    ...
    chassis.moveToPoint(-47.5, -48, 500, {.maxSpeed = 80, .maxAngularSpeed = 10, .minSpeed = 60});
    chassis.turnToPoint(-47.5, -72, 300, {}, false);
    ...
    drop.toggle();
    chassis.moveToPoint(-10, -10, 950, {.forwards = false, .maxSpeed = 90, .maxAngularSpeed = 15, .minSpeed = 50, .earlyExitRange = 5});
    chassis.moveToPoint(-7.8, -8, 500, {.forwards = false, .maxSpeed = 40, .maxAngularSpeed = 10}, false);
    chassis.turnToPoint(5, 5, 250, {.forwards = false}, false);
    Score(30);
...
void lowGoalSoloSigAWP() {
    ...
    //matchload
    chassis.moveToPoint(-46, -48, 850, { .maxSpeed = 85, .maxAngularSpeed = 10}, false);
    chassis.turnToPoint(-47.4, -72, 525, {}, false);
    matchloader.extend();
    Intake();
    shotgun.move(0);
    pros::delay(100);
    ...
    // !left long goal
    chassis.moveToPoint(-48, -27, 700, {.forwards = false, .maxSpeed = 80, .maxAngularSpeed = 10}, false);
    moveWithVoltage(-50, -50);
    Score(45);
    pros::delay(450);
    ...
    chassis.moveToPoint(47, -50, 800, {.maxSpeed = 100}, false);
    ...
    passTheJuice.toggle();
    chassis.turnToPoint(47.5, -72, 400, {}, false);
    chassis.moveDistance(20, 600, {.maxSpeed = 45}, false);
    Intake();
    shotgun.move(0);
    chassis.waitUntilDone();
    ...
    matchloader.retract();
    chassis.turnToPoint(-6, 5, 660, {}, false);
    chassis.moveToPoint(7.2, -8, 1200, {.maxSpeed = 80, .maxAngularSpeed = 20}, false);
    intake.move(-40);
